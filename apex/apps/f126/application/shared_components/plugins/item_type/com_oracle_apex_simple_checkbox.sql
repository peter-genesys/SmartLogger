...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(17263096309014483641)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(17263141206253558450)
,p_plugin_id=>wwv_flow_api.id(17263096309014483641)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(17263692410201761827)
,p_plugin_id=>wwv_flow_api.id(17263096309014483641)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(17263691905007760330)
,p_plugin_id=>wwv_flow_api.id(17263096309014483641)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(15477704808853722870)
,p_plugin_id=>wwv_flow_api.id(17263096309014483641)
