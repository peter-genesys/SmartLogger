...
prompt  APPLICATION 103 - Logger
--
-- Application Export:
--   Application:     103
--   Name:            Logger
--   Date and Time:   10:36 Thursday April 17, 2014
--   Exported By:     PBURGESS
--   Flashback:       0
...
begin
  ...
  wwv_flow_api.set_security_group_id(p_security_group_id=>nvl(wwv_flow_application_install.get_workspace_id,12033420621133505));
...
wwv_flow_api.create_flow(
  ...
  p_owner => nvl(wwv_flow_application_install.get_schema,'TPDS'),
  ...
  p_default_page_template=> 15242047176321397 + wwv_flow_api.g_id_offset,
  p_printer_friendly_template=> 15242235237321397 + wwv_flow_api.g_id_offset,
  p_default_region_template=> 15244525552321400 + wwv_flow_api.g_id_offset,
  p_error_template=> 15242047176321397 + wwv_flow_api.g_id_offset,
  p_page_protection_enabled_y_n=> 'Y',
  p_checksum_salt_last_reset => '20140417103500',
  ...
  p_cust_authentication_process=> '.'||to_char(15249241998321434 + wwv_flow_api.g_id_offset)||'.',
  ...
  p_theme_id => 1,
  p_default_label_template => 15247941014321416 + wwv_flow_api.g_id_offset,
  p_default_report_template => 15247238810321404 + wwv_flow_api.g_id_offset,
  p_default_list_template => 15246530641321402 + wwv_flow_api.g_id_offset,
  p_default_menu_template => 15248234630321416 + wwv_flow_api.g_id_offset,
  p_default_button_template => 15242743300321398 + wwv_flow_api.g_id_offset,
  p_default_chart_template => 15243650177321400 + wwv_flow_api.g_id_offset,
  p_default_form_template => 15243739060321400 + wwv_flow_api.g_id_offset,
  p_default_wizard_template => 15245124950321401 + wwv_flow_api.g_id_offset,
  p_default_tabform_template => 15244525552321400 + wwv_flow_api.g_id_offset,
  p_default_reportr_template   =>15244525552321400 + wwv_flow_api.g_id_offset,
  p_default_menur_template => 15243349377321400 + wwv_flow_api.g_id_offset,
  p_default_listr_template => 15243929859321400 + wwv_flow_api.g_id_offset,
  p_default_irr_template => 15244237470321400 + wwv_flow_api.g_id_offset,
  p_last_updated_by => 'PBURGESS',
  p_last_upd_yyyymmddhh24miss=> '20140417103500',
...
wwv_flow_api.create_icon_bar_item(
  p_id => 15249525586321434 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_flow_item(
  p_id=> 15255941812334677 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
wwv_flow_api.create_tab (
  p_id=> 15250942519321444 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 10,
  p_tab_name=> 'T_PAGE_1',
...
wwv_flow_api.create_tab (
  p_id=> 15315933178754008 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 15,
...
wwv_flow_api.create_tab (
  p_id=> 15315628545743269 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_tab_set=> 'TS1',
  p_tab_sequence=> 20,
...
wwv_flow_api.create_page_plug (
  p_id=> 15251049272321444 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Page 1',
  p_region_name=>'',
  p_plug_template=> 15244525552321400+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 15251235361321446 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 1,
  p_plug_name=> 'Breadcrumbs',
  p_region_name=>'',
  p_plug_template=> 15243349377321400+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 1,
  p_plug_display_column=> 1,
  p_plug_display_point=> 'REGION_POSITION_01',
  p_plug_source=> s,
  p_plug_source_type=> 'M'|| to_char(15250630392321441 + wwv_flow_api.g_id_offset),
  p_menu_template_id=> 15248234630321416+ wwv_flow_api.g_id_offset,
...
''||chr(10)||
''||chr(10)||
'function set_value(p_field,p_value) {'||chr(10)||
'	document.getElementById(p_field).value=p_value;'||chr(10)||
'}'||chr(10)||
''||chr(10)||
'	function view_any_page(p_page_no, p_page_name, p_id_field, p_id_value, p_id_name) {'||chr(10)||
'		if ( p_id_value ) {'||chr(10)||
'			// get the app items from the form vars'||chr(10)||
'			var l_app_id = $v(''pFlowId'');'||chr(10)||
'			var l_app_session = $v(''pInstance'');'||chr(10)||
'			var l_debug = $v(''pdebug'');'||chr(10)||
'			// open the tab'||chr(10)||
'	'||
'		top.Ext.app.tabs.viewTab(p_page_no, p_id_value, p_page_name + '' - '' + p_id_name, ''f?p='' + l_app_id + '':'' + p_page_no + '':'' + l_app_session + ''::'' + l_debug + '':'' + p_page_no + '':'' + p_id_field + '':'' + p_id_value);'||chr(10)||
'		}'||chr(10)||
'	}'||chr(10)||
''||chr(10)||
'</script>'
...
'No help is available for this page.'
 ,p_last_updated_by => 'PBURGESS'
 ,p_last_upd_yyyymmddhh24miss => '20140416163058'
  );
null;
...
'select level'||chr(10)||
'        ,ut.*'||chr(10)||
'      ,''<span style="padding-left:''||LEVEL*10||''px;">''||ut.unit_name||''</span>'' level_unit_name'||chr(10)||
'  from ms_unit_traversal_vw ut'||chr(10)||
'  start with ut.traversal_id = :P8_TRAVERSAL_ID'||chr(10)||
'  connect by prior ';

s:=s||'ut.TRAVERSAL_ID = ut.PARENT_TRAVERSAL_ID'||chr(10)||
'  order siblings by ut.TRAVERSAL_ID) a'||chr(10)||
'  ,ms_message_vw m'||chr(10)||
'where m.traversal_id = a.traversal_id';

wwv_flow_api.create_page_plug (
  p_id=> 15272533125366158 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
...
a1:=a1||'ut.TRAVERSAL_ID = ut.PARENT_TRAVERSAL_ID'||chr(10)||
'  order siblings by ut.TRAVERSAL_ID) a'||chr(10)||
'  ,ms_message_vw m'||chr(10)||
'where m.traversal_id = a.traversal_id';

wwv_flow_api.create_worksheet(
  p_id=> 15272718787366159+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_region_id=> 15272533125366158+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_worksheet_column(
  p_id => 15272821209366159+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 15272940042366159+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 15273031954366159+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 15273121256366159+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 15273240141366159+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 15273348218366159+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 15273431366366159+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 15273532650366159+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 15273639502366160+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 15273718215366160+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 15273828233366160+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 15273938880366160+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 15274033382366160+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 15274142603366160+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 15274234863366160+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 15274327260366160+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 15274442692366160+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 15274534063366160+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 15274647257366160+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 15274726238366160+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 15274831702366161+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_column(
  p_id => 15274934067366161+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_worksheet_rpt(
  p_id => 15277637951366162+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
wwv_flow_api.create_worksheet_condition(
  p_id => 15278143691366162+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_report_id => 15277637951366162+wwv_flow_api.g_id_offset,
  p_name                    =>'Warning',
...
begin
wwv_flow_api.create_worksheet_condition(
  p_id => 15277925508366162+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_report_id => 15277637951366162+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_condition(
  p_id => 15278044392366162+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_report_id => 15277637951366162+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_condition(
  p_id => 15278445892366163+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_report_id => 15277637951366162+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_condition(
  p_id => 15278219884366162+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_report_id => 15277637951366162+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_condition(
  p_id => 15278347002366163+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_report_id => 15277637951366162+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_condition(
  p_id => 15277822705366162+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_report_id => 15277637951366162+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_worksheet_rpt(
  p_id => 15275031593366161+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
begin
wwv_flow_api.create_worksheet_condition(
  p_id => 15275518053366161+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_report_id => 15275031593366161+wwv_flow_api.g_id_offset,
  p_name                    =>'Warning',
  p_condition_type          =>'HIGHLIGHT',
  p_allow_delete            =>'Y',
  p_column_name             =>'MSG_LEVEL_TEXT',
...
begin
wwv_flow_api.create_worksheet_condition(
  p_id => 15275328196366161+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_report_id => 15275031593366161+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_condition(
  p_id => 15275429595366161+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_report_id => 15275031593366161+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_condition(
  p_id => 15275842811366161+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_report_id => 15275031593366161+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_condition(
  p_id => 15275643846366161+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_report_id => 15275031593366161+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_condition(
  p_id => 15275733008366161+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_report_id => 15275031593366161+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_condition(
  p_id => 15275230490366161+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_report_id => 15275031593366161+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_worksheet_rpt(
  p_id => 15275946990366161+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
begin
wwv_flow_api.create_worksheet_condition(
  p_id => 15276130121366161+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_report_id => 15275946990366161+wwv_flow_api.g_id_offset,
  p_name                    =>'Unit Name',
  p_condition_type          =>'HIGHLIGHT',
  p_allow_delete            =>'Y',
  p_column_name             =>'LEVEL_UNIT_NAME',
...
begin
wwv_flow_api.create_worksheet_condition(
  p_id => 15276229196366161+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_report_id => 15275946990366161+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_condition(
  p_id => 15276624315366162+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_report_id => 15275946990366161+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_condition(
  p_id => 15276423778366161+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_report_id => 15275946990366161+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_condition(
  p_id => 15276537056366162+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_report_id => 15275946990366161+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_condition(
  p_id => 15276329828366161+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_report_id => 15275946990366161+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_worksheet_rpt(
  p_id => 15276725807366162+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_session_id  => null,
...
begin
wwv_flow_api.create_worksheet_condition(
  p_id => 15277239753366162+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_report_id => 15276725807366162+wwv_flow_api.g_id_offset,
  p_name                    =>'Warning',
  p_condition_type          =>'HIGHLIGHT',
  p_allow_delete            =>'Y',
  p_column_name             =>'MSG_LEVEL_TEXT',
...
begin
wwv_flow_api.create_worksheet_condition(
  p_id => 15277021330366162+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_report_id => 15276725807366162+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_condition(
  p_id => 15277142828366162+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_report_id => 15276725807366162+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_condition(
  p_id => 15277534866366162+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_report_id => 15276725807366162+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_condition(
  p_id => 15277317946366162+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_report_id => 15276725807366162+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_condition(
  p_id => 15277433047366162+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_report_id => 15276725807366162+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_worksheet_condition(
  p_id => 15276946544366162+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_worksheet_id => 15272718787366159+wwv_flow_api.g_id_offset,
  p_report_id => 15276725807366162+wwv_flow_api.g_id_offset,
...
'       level, '||chr(10)||
'       "TRAVERSAL_ID" as title, '||chr(10)||
'       null as icon, '||chr(10)||
'       "TRAVERSAL_ID" as value, '||chr(10)||
'       "TRAVERSAL_ID" as tooltip, '||chr(10)||
'       null as link '||chr(10)||
'from "#OWNER#"."MS_TRAVERSAL_MESSAGE_REF_VW"'||chr(10)||
'start with "TRAVERSAL_ID" is null'||chr(10)||
'c';

s:=s||'onnect by prior "TRAVERSAL_ID" = "TRAVERSAL_ID"'||chr(10)||
'order siblings by "MESSAGE_ID"';

wwv_flow_api.create_page_plug (
  p_id=> 15278736746366164 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_plug_name=> 'Traversals',
  p_region_name=>'',
  p_plug_template=> 15243739060321400+ wwv_flow_api.g_id_offset,
  p_plug_display_sequence=> 10,
...
a1:=a1||'k, '||chr(10)||
'       TRAVERSAL_ID,'||chr(10)||
'       PARENT_TRAVERSAL_ID'||chr(10)||
'from ms_unit_traversal_vw'||chr(10)||
'start with PARENT_TRAVERSAL_ID is null and process_id = :P8_PROCESS_ID'||chr(10)||
'connect by prior TRAVERSAL_ID = PARENT_TRAVERSAL_ID'||chr(10)||
'order siblings by TRAVERSAL_ID'||chr(10)||
'';

wwv_flow_api.create_jstree(
  p_id => 15278947632366164+wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id => 8,
  p_region_id => 15278736746366164+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_report_region (
  p_id=> 15279725149366165 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 8,
  p_name=> 'Processes',
  p_region_name=>'',
  p_template=> 15243739060321400+ wwv_flow_api.g_id_offset,
  ...
  p_translate_title=> 'Y',
  p_ajax_enabled=> 'Y',
  p_query_row_template=> 15247238810321404+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_report_columns (
  p_id=> 15279919156366166 + wwv_flow_api.g_id_offset,
  p_region_id=> 15279725149366165 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 15280019466366166 + wwv_flow_api.g_id_offset,
  p_region_id=> 15279725149366165 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 15280118950366166 + wwv_flow_api.g_id_offset,
  p_region_id=> 15279725149366165 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 15280237738366166 + wwv_flow_api.g_id_offset,
  p_region_id=> 15279725149366165 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 15280331951366166 + wwv_flow_api.g_id_offset,
  p_region_id=> 15279725149366165 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 5,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 15280423465366166 + wwv_flow_api.g_id_offset,
  p_region_id=> 15279725149366165 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 6,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 15280532823366166 + wwv_flow_api.g_id_offset,
  p_region_id=> 15279725149366165 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 7,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 15280621271366166 + wwv_flow_api.g_id_offset,
  p_region_id=> 15279725149366165 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 8,
  p_form_element_id=> null,
...
wwv_flow_api.create_page_button(
  p_id             => 15280744280366166 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 8,
  p_button_sequence=> 20,
  p_button_plug_id => 15279725149366165+wwv_flow_api.g_id_offset,
  p_button_name    => 'PURGE',
  p_button_image   => 'template:'||to_char(15242743300321398+wwv_flow_api.g_id_offset),
...
wwv_flow_api.create_page_button(
  p_id             => 15280931578366166 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 8,
...
wwv_flow_api.create_page_button(
  p_id             => 15279122042366165 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 8,
  p_button_sequence=> 10,
  p_button_plug_id => 15278736746366164+wwv_flow_api.g_id_offset,
  p_button_name    => 'CONTRACT_ALL',
  p_button_image   => 'template:'||to_char(15242743300321398+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Collapse All',
  p_button_position=> 'REGION_TEMPLATE_CREATE',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'javascript:apex.widget.tree.collapse_all(''tree'||to_char(12470619471065286+wwv_flow_api.g_id_offset)||''');',
  p_button_execute_validations=>'Y',
  p_required_patch => null + wwv_flow_api.g_id_offset);
 
wwv_flow_api.create_page_button(
  p_id             => 15279341523366165 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 8,
  p_button_sequence=> 10,
  p_button_plug_id => 15278736746366164+wwv_flow_api.g_id_offset,
  ...
  p_button_position=> 'REGION_TEMPLATE_CREATE',
  p_button_alignment=> 'RIGHT',
  p_button_redirect_url=> 'javascript:apex.widget.tree.expand_all(''tree'||to_char(12470619471065286+wwv_flow_api.g_id_offset)||''');',
  p_button_execute_validations=>'Y',
  p_required_patch => null + wwv_flow_api.g_id_offset);
...
wwv_flow_api.create_page_item(
  p_id=>15278536864366163 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 8,
  ...
  p_item_sequence=> 10,
  p_item_plug_id => 15272533125366158+wwv_flow_api.g_id_offset,
...
begin
wwv_flow_api.create_page_item(
  p_id=>15279535753366165 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 8,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 15278736746366164+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source_type=> 'STATIC',
  p_display_as=> 'NATIVE_HIDDEN',
...
wwv_flow_api.create_page_process(
  p_id     => 15281148038366166 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 8,
  ...
  p_process_when_button_id=>15280744280366166 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_process(
  p_id     => 15281320333366167 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 8,
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_when_button_id=>15280931578366166 + wwv_flow_api.g_id_offset,
  p_process_success_message=> 'Purged old messages',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
s:=s||'select '||chr(10)||
'"MODULE_ID",'||chr(10)||
'"MODULE_ID" MODULE_ID_DISPLAY,'||chr(10)||
'"MODULE_NAME",'||chr(10)||
'"REVISION",'||chr(10)||
'"MODULE_TYPE",'||chr(10)||
'"MSG_MODE",'||chr(10)||
'"OPEN_PROCESS"'||chr(10)||
'from "#OWNER#"."MS_MODULE"'||chr(10)||
'';

wwv_flow_api.create_report_region (
  p_id=> 15285444675411513 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 9,
  p_name=> 'Tabular Form',
  p_region_name=>'',
  p_template=> 15244635161321400+ wwv_flow_api.g_id_offset,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 15285649914411513 + wwv_flow_api.g_id_offset,
  p_region_id=> 15285444675411513 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
...
wwv_flow_api.create_report_columns (
  p_id=> 15285733956411513 + wwv_flow_api.g_id_offset,
  p_region_id=> 15285444675411513 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 15285843699411513 + wwv_flow_api.g_id_offset,
  p_region_id=> 15285444675411513 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 15285937578411513 + wwv_flow_api.g_id_offset,
  p_region_id=> 15285444675411513 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 15286024472411513 + wwv_flow_api.g_id_offset,
  p_region_id=> 15285444675411513 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 5,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 15286142441411513 + wwv_flow_api.g_id_offset,
  p_region_id=> 15285444675411513 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 6,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 15286225282411513 + wwv_flow_api.g_id_offset,
  p_region_id=> 15285444675411513 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 7,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 15286347849411513 + wwv_flow_api.g_id_offset,
  p_region_id=> 15285444675411513 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 8,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 15317125606780226 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 9,
...
wwv_flow_api.create_page_button(
  p_id             => 15286431154411514 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 9,
  p_button_sequence=> 30,
  p_button_plug_id => 15285444675411513+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 15286631950411521 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 9,
...
wwv_flow_api.create_page_button(
  p_id             => 15286835161411521 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 9,
  p_button_sequence=> 10,
  p_button_plug_id => 15285444675411513+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 15287035212411522 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 9,
  p_button_sequence=> 20,
  p_button_plug_id => 15285444675411513+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>15288120721411526 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 9,
...
wwv_flow_api.create_page_validation(
  p_id => 15287327164411523 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 9,
  p_tabular_form_region_id => 15285444675411513 + wwv_flow_api.g_id_offset,
  p_validation_name => 'MSG_MODE must be numeric',
  p_validation_sequence=> 60,
  p_validation => 'MSG_MODE',
  p_validation_type => 'COL_IS_NUMERIC',
  p_error_message => '#COLUMN_HEADER# must be numeric.',
  p_when_button_pressed=> 15286431154411514 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_process(
  p_id     => 15287437861411525 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 9,
  ...
  p_process_when_button_id=>15286431154411514 + wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_process(
  p_id     => 15287650130411525 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 9,
...
wwv_flow_api.create_page_process(
  p_id     => 15287835099411525 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 9,
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> '',
  p_process_when_button_id=>15286631950411521 + wwv_flow_api.g_id_offset,
  p_process_success_message=> 'Purged old messages',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
s:=s||'select '||chr(10)||
'"UNIT_ID",'||chr(10)||
'"UNIT_ID" UNIT_ID_DISPLAY,'||chr(10)||
'"UNIT_NAME",'||chr(10)||
'"UNIT_TYPE",'||chr(10)||
'"MODULE_ID",'||chr(10)||
'"MSG_MODE",'||chr(10)||
'"OPEN_PROCESS"'||chr(10)||
'from "#OWNER#"."MS_UNIT"'||chr(10)||
'where module_id = :P10_MODULE_ID'||chr(10)||
'';

wwv_flow_api.create_report_region (
  p_id=> 15290727027421084 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 10,
  p_name=> 'Tabular Form',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 15290927701421084 + wwv_flow_api.g_id_offset,
  p_region_id=> 15290727027421084 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 1,
  p_form_element_id=> null,
  p_column_alias=> 'CHECK$01',
...
wwv_flow_api.create_report_columns (
  p_id=> 15291021900421084 + wwv_flow_api.g_id_offset,
  p_region_id=> 15290727027421084 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 2,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 15291138473421084 + wwv_flow_api.g_id_offset,
  p_region_id=> 15290727027421084 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 3,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 15291249942421084 + wwv_flow_api.g_id_offset,
  p_region_id=> 15290727027421084 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 4,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 15291343695421084 + wwv_flow_api.g_id_offset,
  p_region_id=> 15290727027421084 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 5,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 15291440252421084 + wwv_flow_api.g_id_offset,
  p_region_id=> 15290727027421084 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 6,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 15291548487421084 + wwv_flow_api.g_id_offset,
  p_region_id=> 15290727027421084 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 7,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_report_columns (
  p_id=> 15291643430421084 + wwv_flow_api.g_id_offset,
  p_region_id=> 15290727027421084 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_query_column_id=> 8,
  p_form_element_id=> null,
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 15317539458784164 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 10,
  p_plug_name=> 'Breadcrumb',
  p_region_name=>'',
...
wwv_flow_api.create_page_button(
  p_id             => 15291734522421084 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 10,
  p_button_sequence=> 30,
  p_button_plug_id => 15290727027421084+wwv_flow_api.g_id_offset,
  p_button_name    => 'SUBMIT',
  p_button_image   => 'template:'||to_char(15242743300321398+wwv_flow_api.g_id_offset),
  p_button_image_alt=> 'Submit',
  p_button_position=> 'REGION_TEMPLATE_CHANGE',
...
wwv_flow_api.create_page_button(
  p_id             => 15291936721421084 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 10,
  p_button_sequence=> 10,
  p_button_plug_id => 15290727027421084+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 15292134448421084 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 10,
  p_button_sequence=> 20,
  p_button_plug_id => 15290727027421084+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_branch(
  p_id=>15293223816421085 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
...
begin
wwv_flow_api.create_page_item(
  p_id=>15292344395421084 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 10,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 15290727027421084+wwv_flow_api.g_id_offset,
  p_use_cache_before_default=> 'YES',
  p_item_default_type=> 'STATIC_TEXT_WITH_SUBSTITUTIONS',
  p_source_type=> 'STATIC',
  p_display_as=> 'NATIVE_HIDDEN',
...
wwv_flow_api.create_page_validation(
  p_id => 15292638065421085 + wwv_flow_api.g_id_offset,
  p_flow_id => wwv_flow.g_flow_id,
  p_flow_step_id => 10,
  p_tabular_form_region_id => 15290727027421084 + wwv_flow_api.g_id_offset,
  p_validation_name => 'MSG_MODE must be numeric',
  p_validation_sequence=> 60,
  p_validation => 'MSG_MODE',
  p_validation_type => 'COL_IS_NUMERIC',
  p_error_message => '#COLUMN_HEADER# must be numeric.',
  p_when_button_pressed=> 15291734522421084 + wwv_flow_api.g_id_offset,
  p_associated_column=> 'MSG_MODE',
  p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION',
  p_validation_comment=> '');
...
wwv_flow_api.create_page_process(
  p_id     => 15292942827421085 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 10,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
  ...
  p_process_sql_clob => p, 
  p_process_error_message=> 'Unable to process update.',
  p_process_when_button_id=>15291734522421084 + wwv_flow_api.g_id_offset,
  p_process_success_message=> '#MRU_COUNT# row(s) updated, #MRI_COUNT# row(s) inserted.',
  p_process_is_stateful_y_n=>'N',
  p_process_comment=>'');
end;
...
wwv_flow_api.create_page_process(
  p_id     => 15292729560421085 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 10,
  p_process_sequence=> 20,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page (
 ...
 ,p_step_template => 15241242070321395 + wwv_flow_api.g_id_offset
 ,p_page_is_public_y_n => 'N'
 ,p_cache_page_yn => 'N'
 ,p_last_upd_yyyymmddhh24miss => '20140415151502'
  );
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 15249833895321437 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 101,
  p_plug_name=> 'Login',
  p_region_name=>'',
...
begin
wwv_flow_api.create_page_item(
  p_id=>15249943299321439 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  ...
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 15249833895321437+wwv_flow_api.g_id_offset,
  ...
  p_field_alignment=> 'LEFT',
  p_field_template=> 15247941014321416+wwv_flow_api.g_id_offset,
  p_is_persistent=> 'Y',
  p_attribute_01 => 'N',
  p_attribute_02 => 'N',
  p_attribute_03 => 'N',
...
begin
wwv_flow_api.create_page_item(
  p_id=>15250044801321440 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
...
begin
wwv_flow_api.create_page_item(
  p_id=>15250121410321440 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 101,
  p_name=>'P101_LOGIN',
  p_data_type=> '',
  ...
  p_cMaxlength=> null,
  p_cHeight=> null,
  p_tag_attributes  => 'template:'||to_char(15242743300321398 + wwv_flow_api.g_id_offset),
  p_begin_on_new_line=> 'NO',
  p_begin_on_new_field=> 'YES',
  p_colspan=> 1,
  p_rowspan=> 1,
...
wwv_flow_api.create_page_process(
  p_id     => 15250344495321441 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 15250241108321441 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 20,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 15250529794321441 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 30,
  p_process_point=> 'AFTER_SUBMIT',
...
wwv_flow_api.create_page_process(
  p_id     => 15250424519321441 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id => 101,
  p_process_sequence=> 10,
...
wwv_flow_api.create_menu (
  p_id=> 15250630392321441 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> ' Breadcrumb');
 
wwv_flow_api.create_menu_option (
  p_id=>15251137160321445 + wwv_flow_api.g_id_offset,
  p_menu_id=>15250630392321441 + wwv_flow_api.g_id_offset,
  p_parent_id=>0,
...
wwv_flow_api.create_menu_option (
  p_id=>15317442301780234 + wwv_flow_api.g_id_offset,
  p_menu_id=>15250630392321441 + wwv_flow_api.g_id_offset,
  p_parent_id=>null,
  p_option_sequence=>10,
...
wwv_flow_api.create_menu_option (
  p_id=>15317833674784165 + wwv_flow_api.g_id_offset,
  p_menu_id=>15250630392321441 + wwv_flow_api.g_id_offset,
  p_parent_id=>15317442301780234 + wwv_flow_api.g_id_offset,
  p_option_sequence=>10,
...
wwv_flow_api.create_menu (
  p_id=> 15317047508767562 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Logger');
...
prompt  ......Page template 15241242070321395
...
wwv_flow_api.create_template(
  p_id=> 15241242070321395 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Login',
  p_body_title=> '',
...
prompt  ......Page template 15241341763321396
...
wwv_flow_api.create_template(
  p_id=> 15241341763321396 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 15241418374321396
...
wwv_flow_api.create_template(
  p_id=> 15241418374321396 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 15241530824321396
...
wwv_flow_api.create_template(
  p_id=> 15241530824321396 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 15241641798321396
...
wwv_flow_api.create_template(
  p_id=> 15241641798321396 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 15241737436321397
...
wwv_flow_api.create_template(
  p_id=> 15241737436321397 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 15241832467321397
...
wwv_flow_api.create_template(
  p_id=> 15241832467321397 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 15241917996321397
...
wwv_flow_api.create_template(
  p_id=> 15241917996321397 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 15242047176321397
...
wwv_flow_api.create_template(
  p_id=> 15242047176321397 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 15242138508321397
...
wwv_flow_api.create_template(
  p_id=> 15242138508321397 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'Popup',
  p_body_title=> '',
  p_header_template=> c1,
...
prompt  ......Page template 15242235237321397
...
wwv_flow_api.create_template(
  p_id=> 15242235237321397 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 15242323733321397
...
wwv_flow_api.create_template(
  p_id=> 15242323733321397 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 15242422357321398
...
wwv_flow_api.create_template(
  p_id=> 15242422357321398 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 15242524438321398
...
wwv_flow_api.create_template(
  p_id=> 15242524438321398 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Page template 15242621824321398
...
wwv_flow_api.create_template(
  p_id=> 15242621824321398 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......Button Template 15242743300321398
declare
...
wwv_flow_api.create_button_templates (
  p_id=>15242743300321398 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 15242825484321399
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>15242825484321399 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 15242918315321399
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>15242918315321399 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......Button Template 15243050267321399
declare
  t varchar2(32767) := null;
  l_clob clob;
  l_length number := 1;
...
wwv_flow_api.create_button_templates (
  p_id=>15243050267321399 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_template=>t,
...
prompt  ......region template 15243125326321399
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 15243125326321399 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 15243218912321400
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 15243218912321400 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 15243349377321400
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 15243349377321400 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 15243426797321400
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 15243426797321400 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-top">'||chr(10)||
...
prompt  ......region template 15243536853321400
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 15243536853321400 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-top">'||chr(10)||
...
prompt  ......region template 15243650177321400
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 15243650177321400 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 15243739060321400
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 15243739060321400 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
...
prompt  ......region template 15243825210321400
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 15243825210321400 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 15243929859321400
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 15243929859321400 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-red-top"><div class="rc-red-top-r">'||chr(10)||
...
prompt  ......region template 15244020360321400
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 15244020360321400 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 15244135517321400
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 15244135517321400 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 15244237470321400
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 15244237470321400 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-body">#BODY#</div>'||chr(10)||
...
prompt  ......region template 15244335623321400
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 15244335623321400 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="borderless-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="bl-top">'||chr(10)||
...
prompt  ......region template 15244442342321400
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 15244442342321400 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 15244525552321400
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 15244525552321400 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-gray-top"><div class="rc-gray-top-r">'||chr(10)||
...
prompt  ......region template 15244635161321400
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 15244635161321400 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 15244724052321400
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 15244724052321400 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-red-top"><div class="rc-red-top-r">'||chr(10)||
...
prompt  ......region template 15244848526321400
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 15244848526321400 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 15244943835321400
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 15244943835321400 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 15245025372321400
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 15245025372321400 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
...
prompt  ......region template 15245124950321401
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 15245124950321401 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-red-top"><div class="rc-red-top-r">'||chr(10)||
...
prompt  ......region template 15245243745321401
 
begin
 
wwv_flow_api.create_plug_template (
  p_id => 15245243745321401 + wwv_flow_api.g_id_offset
 ,p_flow_id => wwv_flow.g_flow_id
 ,p_template => 
'<div class="rounded-corner-region" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>'||chr(10)||
'  <div class="rc-red-top"><div class="rc-red-top-r">'||chr(10)||
...
prompt  ......list template 15245337693321401
...
wwv_flow_api.create_list_template (
  p_id=>15245337693321401 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
...
prompt  ......list template 15245430355321402
...
wwv_flow_api.create_list_template (
  p_id=>15245430355321402 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 15245543287321402
...
wwv_flow_api.create_list_template (
  p_id=>15245543287321402 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 15245623387321402
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>15245623387321402 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 15245743524321402
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>15245743524321402 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 15245834995321402
...
wwv_flow_api.create_list_template (
  p_id=>15245834995321402 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 15245937746321402
...
wwv_flow_api.create_list_template (
  p_id=>15245937746321402 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 15246034940321402
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>15246034940321402 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 15246134826321402
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>15246134826321402 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 15246228037321402
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>15246228037321402 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 15246318903321402
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>15246318903321402 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 15246425594321402
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>15246425594321402 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 15246530641321402
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>15246530641321402 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 15246650035321402
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>15246650035321402 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......list template 15246744799321402
...
t8 := null;
wwv_flow_api.create_list_template (
  p_id=>15246744799321402 + wwv_flow_api.g_id_offset,
  p_flow_id=>wwv_flow.g_flow_id,
  p_list_template_current=>t,
  p_list_template_noncurrent=> t2,
...
prompt  ......report template 15246819621321403
...
wwv_flow_api.create_row_template (
  p_id=> 15246819621321403 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 15246921021321404
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 15246921021321404 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 15247046291321404
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 15247046291321404 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 15247139184321404
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 15247139184321404 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 15247238810321404
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 15247238810321404 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 15247336178321404
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 15247336178321404 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 15247427570321404
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 15247427570321404 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 15247529396321404
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 15247529396321404 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......report template 15247647532321404
...
c4 := null;
wwv_flow_api.create_row_template (
  p_id=> 15247647532321404 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 15247746991321415
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 15247746991321415 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 15247841954321415
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 15247841954321415 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 15247941014321416
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 15247941014321416 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 15248023823321416
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 15248023823321416 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......label template 15248123530321416
 
begin
 
begin
wwv_flow_api.create_field_template (
  p_id=> 15248123530321416 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 15248234630321416
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 15248234630321416 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 15248349662321416
 
begin
 
begin
wwv_flow_api.create_menu_template (
  p_id=> 15248349662321416 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
--
prompt  ......template 15249028429321429
 
begin
 
begin
wwv_flow_api.create_popup_lov_template (
  p_id=> 15249028429321429 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 15248444870321416
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 15248444870321416 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 15248649245321418
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 15248649245321418 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......template 15248829520321418
 
begin
 
begin
wwv_flow_api.create_calendar_template(
  p_id=> 15248829520321418 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......theme 15249126461321429
begin
wwv_flow_api.create_theme (
  p_id =>15249126461321429 + wwv_flow_api.g_id_offset,
  p_flow_id =>wwv_flow.g_flow_id,
  p_theme_id  => 1,
  ...
  p_login_template=>15241242070321395 + wwv_flow_api.g_id_offset,
  p_default_button_template=>15242743300321398 + wwv_flow_api.g_id_offset,
  p_default_region_template=>15244525552321400 + wwv_flow_api.g_id_offset,
  p_default_chart_template =>15243650177321400 + wwv_flow_api.g_id_offset,
  p_default_form_template  =>15243739060321400 + wwv_flow_api.g_id_offset,
  ...
  p_default_label_template=>15247941014321416 + wwv_flow_api.g_id_offset,
  p_default_menu_template=>15248234630321416 + wwv_flow_api.g_id_offset,
  p_default_calendar_template=>15248444870321416 + wwv_flow_api.g_id_offset,
  p_default_list_template=>15246530641321402 + wwv_flow_api.g_id_offset,
  p_default_option_label=>15247941014321416 + wwv_flow_api.g_id_offset,
  p_default_required_label=>15248123530321416 + wwv_flow_api.g_id_offset);
end;
/
...
prompt  ......scheme 15249241998321434
...
wwv_flow_api.create_auth_setup (
  p_id=> 15249241998321434 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
...
prompt  ......scheme 15249322775321434
...
s5 := null;
wwv_flow_api.create_auth_setup (
  p_id=> 15249322775321434 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_name=> 'DATABASE',
...
prompt  ......scheme 15249427570321434
...
s5 := null;
wwv_flow_api.create_auth_setup (
  p_id=> 15249427570321434 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
