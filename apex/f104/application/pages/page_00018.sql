...
wwv_flow_api.create_page (
 ...
 ,p_tab_set => 'TS1'
 ,p_name => 'Step 5 Result'
 ,p_step_title => 'Step 5 Result'
...
'No help is available for this page.'
 ...
 ,p_last_upd_yyyymmddhh24miss => '20140508173413'
  );
null;
...
wwv_flow_api.create_page_plug (
  p_id=> 2746029984876020 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 18,
  p_plug_name=> 'Step 5 Result',
  p_region_name=>'',
...
s := null;
wwv_flow_api.create_page_plug (
  p_id=> 2746330058876021 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_page_id=> 18,
...
wwv_flow_api.create_page_button(
  p_id             => 2747407077876022 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 18,
  p_button_sequence=> 10,
  p_button_plug_id => 2746029984876020+wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_button(
  p_id             => 2747527284876022 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 18,
...
wwv_flow_api.create_page_button(
  p_id             => 2747625862876022 + wwv_flow_api.g_id_offset,
  p_flow_id        => wwv_flow.g_flow_id,
  p_flow_step_id   => 18,
...
wwv_flow_api.create_page_branch(
  p_id=>2748427429876022 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 18,
  p_branch_name=> '',
  ...
  p_branch_when_button_id=>2747527284876022+ wwv_flow_api.g_id_offset,
  p_branch_sequence=> 1,
  p_save_state_before_branch_yn=>'N',
  p_branch_comment=> '');
 
wwv_flow_api.create_page_branch(
  p_id=>2748113675876022 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 18,
  p_branch_name=> '',
  ...
  p_branch_type=> 'REDIRECT_URL',
  p_branch_when_button_id=>2747625862876022+ wwv_flow_api.g_id_offset,
...
wwv_flow_api.create_page_item(
  p_id=>2751728640998638 + wwv_flow_api.g_id_offset,
  p_flow_id=> wwv_flow.g_flow_id,
  p_flow_step_id=> 18,
  p_name=>'P18_AOP_HTML_TEXT',
  p_data_type=> 'VARCHAR',
  p_is_required=> false,
  p_accept_processing=> 'REPLACE_EXISTING',
  p_item_sequence=> 10,
  p_item_plug_id => 2746029984876020+wwv_flow_api.g_id_offset,
