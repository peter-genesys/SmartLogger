...
wwv_flow_api.create_flow(
  ...
  p_name  => nvl(wwv_flow_application_install.get_application_name,'Logger'),
  p_alias => nvl(wwv_flow_application_install.get_application_alias,'F102103'),
  p_page_view_logging => 'YES',
  p_page_protection_enabled_y_n=> 'Y',
  p_checksum_salt_last_reset => '20140422132353',
  ...
  p_last_upd_yyyymmddhh24miss=> '20140422132353',
  p_ui_type_name => null,
