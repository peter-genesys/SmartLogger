...
execute &&PATCH_ADMIN_user..patch_installer.patch_started( -
  i_patch_name         => 'VER-02_01A_01B_ENDUSER' -
 ...
 ,i_tag_to             => 'VER-02.01B' -
 ,i_supplementary      => '' -
 ,i_patch_desc         => 'Synonyms for END_USER' -
...
PROMPT
PROMPT Checking Prerequisite patch VER-02_01A_01B_LOGGER
execute &&PATCH_ADMIN_user..patch_installer.add_patch_prereq( -
i_patch_name     => 'VER-02_01A_01B_ENDUSER' -
,i_prereq_patch  => 'VER-02_01A_01B_LOGGER' );
PROMPT
