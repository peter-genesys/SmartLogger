PROMPT LOG TO VER-02_01A_01B_SYS.log
PROMPT .
SET AUTOCOMMIT OFF
SET AUTOPRINT ON
SET ECHO ON
...
define patch_name = 'VER-02_01A_01B_SYS'
define patch_desc = 'Create Logger user'
define patch_path = 'feature/log/VER-02/VER-02_01A_01B_SYS/'
SPOOL VER-02_01A_01B_SYS.log
CONNECT SYS/&&SYS_password@&&database as sysdba
set serveroutput on;
execute &&PATCH_ADMIN_user..patch_installer.patch_started( -
  i_patch_name         => 'VER-02_01A_01B_SYS' -
